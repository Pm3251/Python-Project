def welcome_assignment_answers(question):
     ...
     if question == "What is the MD5 hashing value to the following message: 'Computer Networking' - Use MD5 hash generator and use the answer in your code":
        answer = isalnum(42B76FE51778764973077A5A94056724)
